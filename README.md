...
| [indirect_access](benchmarks/strided_access) | What is the cost of a strided memory access pattern representative of directionally-split 5-point WENO schemses, and what is the role of loop ordering and compiler optimizations? |  |